...
<%!
	...
	//->클라우드 메시징->서버키 복사
	final String apiKey = "AAAAXYluvGc:APA91bEvrGePzcxoyx3VofPIMss41t7NMa80GiLHCFFbl6HetJ3gLaVtpZ_anw1BH8tFxZoAWUslw6qwlmBHXf1ekztaD6XWYSkgVEMfbSzzbKG23AUaWI4izES6E7eGsRAO1ExOhR9P";
...
<%
    ...
    try {
        ...
        conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","token","token");
